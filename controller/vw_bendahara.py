...
class vw_bendahara(db.Model, SerializerMixin):
    __tablename__ = 'vw_bendahara'
        ...
        def get(self, *args, **kwargs):
            ...
            if args['search'] and args['search'] != 'null':
                ...
                select_query = select_query.filter(
                    or_(vw_bendahara.Nama.ilike(search),
            ...
            if args['sort']:
                ...
                select_query = select_query.order_by(vw_bendahara.BendaharaID)
