...
class HistPenetapanReklameHdr(db.Model, SerializerMixin):
    __tablename__ = 'HistPenetapanReklameHdr'
    ...
    OPDID = db.Column(db.Integer, db.ForeignKey('MsWP.OPDID'), nullable=False)
    ...
    class ListAll(Resource):
        ...
        def get(self):
            select_query = HistPenetapanReklameHdr.query.order_by(HistPenetapanReklameHdr.NoKohir).paginate(1, 10)
