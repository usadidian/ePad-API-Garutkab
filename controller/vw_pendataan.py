...
class vw_pendataan(db.Model, SerializerMixin):
    __tablename__ = 'vw_pendataan'
        ...
        def get(self, *args, **kwargs):
            ...
            if args['search'] and args['search'] != 'null':
                ...
                select_query = select_query.filter(
                    or_(vw_pendataan.PendataanID.ilike(search),
                        vw_pendataan.TglPendataan.ilike(search))
                )
            ...
            if args['sort']:
                ...
                select_query = select_query.order_by(vw_pendataan.DateUpd)
